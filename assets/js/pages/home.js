...
export function render() {
    ...
    page.innerHTML = `
        ...
        <section style="padding: 2rem;">
            ...
            <div id="countdown" style="font-size: 2rem; font-weight: bold; text-align: center; margin: 1rem 0;"></div>
            <div class="grid">
                <a href="#calendar" class="card" style="text-decoration:none;color:inherit;text-align:center;">
                    <h3>Kalender Kegiatan</h3>
                    <p>Lihat semua jadwal rutinan dan agenda tahunan.</p>
                </a>
                <a href="#alumni" class="card" style="text-decoration:none;color:inherit;text-align:center;">
                    <h3>Direktori Alumni</h3>
                    <p>Cari teman seangkatan, perluas jaringan.</p>
                </a>
                <a href="#gallery" class="card" style="text-decoration:none;color:inherit;text-align:center;">
                    <h3>Galeri Foto</h3>
